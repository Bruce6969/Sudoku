...
public class BruteFroceAlgorithm {
	...
	public static boolean isValidSudoku(char[][] board) {
		...
		for(int i =0; i<9; i++) {
			for(int j =0; j<9; j++) {
				...
				if(curretValue != '.') {
					if(!seen.add(curretValue + "found in row" + i)|| 
							!seen.add(curretValue+"found in row"+j)||
	...
	public static void main(String[] args) {
		...
		bfa.isValidSudoku(GRID_TO_SOLVE);
		System.out.println(isValidSudoku(GRID_TO_SOLVE));
